          ...
          <div className="glass-card relative overflow-hidden p-8 sm:p-12">
            ...
            <div className="relative grid grid-cols-2 gap-6 lg:grid-cols-4">
              {pillars.map((p, index) => (
                ...
                >
                  <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/10 transition-all duration-300 group-hover:border-cyan-400/60 group-hover:bg-cyan-400/20 group-hover:shadow-glow">
